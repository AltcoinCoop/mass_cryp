...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Masscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    // {"masscointools.com", "dnsseed.masscointools.com"},
    // {"masscoinpool.org", "dnsseed.masscoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    // {"masscointools.com", "testnet-seed.masscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Masscoin is probably already running."), addrBind.ToString().c_str());
        else
